              ...
              <div className="flex mt-6">
                ...
                <div className="ml-6">
                  ...
                  <div className="flex mt-10 space-x-3 sm:pl-6">
                    <a
                      href="/"
                      className="inline-flex items-center px-6 py-4 text-sm text-4xl font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                    >
                      Go back home
                    </a>
                  </div>
